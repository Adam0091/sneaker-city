<template>
  <div class="range-input">
    ...
    <div class="range-input__wrapper">
      <input class="range-min" type="range" :min="min" :max="max" :step="step" v-model.number="range1"
        @input="updateRange" v-if="double" />
      <input class="range-max" type="range" :min="min" :max="max" :step="step" v-model.number="range2"
        @input="updateRange" />
    </div>
  </div>
</template>
